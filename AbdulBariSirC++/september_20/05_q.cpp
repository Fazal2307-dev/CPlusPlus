...
// C
// C.
// Bob doesn't completely trust Alice and asked you to tell him if 
// the answer given by Alice is correct or not.
...
// C.
// Output Format
// For each test case, output on a new line the answer: YES if Alice gave the 
// right answer, and NO otherwise.
