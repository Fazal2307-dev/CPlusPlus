...
// Output Format
// For each test case, output on a new line the answer — YES if Chef will finish his episode 
//before the exam starts, and NO otherwise.

// Each character of the output may be printed in either lowercase or uppercase, i.e, the string Yes, YES, yes, 
//YeS will all be treated as equivalent
